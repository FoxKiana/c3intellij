...
public class C3MacroDefinitionImpl extends C3MacroDefinitionMixinImpl implements C3MacroDefinition {
  ...
  public C3MacroDefinitionImpl(
      @NotNull C3MacroDefinitionStub stub, @NotNull IStubElementType<?, ?> type) {
    super(stub, type);
  }

  public C3MacroDefinitionImpl(
      @NotNull C3MacroDefinitionStub stub, @Nullable IElementType type, @Nullable ASTNode node) {
