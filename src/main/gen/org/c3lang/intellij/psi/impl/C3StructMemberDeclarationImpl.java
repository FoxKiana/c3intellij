...
public class C3StructMemberDeclarationImpl extends C3StructMemberDeclarationMixinImpl
  ...
  public C3StructMemberDeclarationImpl(
      @NotNull C3StructMemberDeclarationStub stub, @NotNull IStubElementType<?, ?> type) {
    super(stub, type);
  }
