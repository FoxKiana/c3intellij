...
public class C3EnumConstantImpl extends C3EnumConstantMixinImpl implements C3EnumConstant {
  ...
  public C3EnumConstantImpl(
      @NotNull C3EnumConstantStub stub, @NotNull IStubElementType<?, ?> type) {
    super(stub, type);
  }

  public C3EnumConstantImpl(
      @NotNull C3EnumConstantStub stub, @Nullable IElementType type, @Nullable ASTNode node) {
