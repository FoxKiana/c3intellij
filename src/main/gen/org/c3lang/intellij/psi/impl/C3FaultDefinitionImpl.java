...
public class C3FaultDefinitionImpl extends C3FaultDefinitionMixinImpl implements C3FaultDefinition {
  ...
  public C3FaultDefinitionImpl(
      @NotNull C3FaultDefinitionStub stub, @NotNull IStubElementType<?, ?> type) {
    super(stub, type);
  }

  public C3FaultDefinitionImpl(
      @NotNull C3FaultDefinitionStub stub, @Nullable IElementType type, @Nullable ASTNode node) {
