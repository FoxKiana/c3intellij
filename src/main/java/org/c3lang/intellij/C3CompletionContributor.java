...
//        {
//            topLevelLookups.add(LookupElementBuilder.create(s + "
// ").withPresentableText(s).bold());
//        }
...
//            insertionContext.getEditor().getCaretModel().moveCaretRelatively(1, 0, false, false,
// false);
//        };
//
...
//                {
//                        @Override
//                        public boolean accepts(@NotNull PsiElement psiElement, ProcessingContext
// processingContext)
//                        {
...
//                            if (sib instanceof C3DefaultModuleSection || sib instanceof
// C3ModuleSection) return true;
//                            return false;
//                        }
//                    });
//
...
//        {
//            public void addCompletions(@NotNull CompletionParameters parameters, @NotNull
