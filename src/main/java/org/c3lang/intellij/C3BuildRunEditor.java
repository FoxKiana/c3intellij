...
public class C3BuildRunEditor extends SettingsEditor<C3BuildRunConfiguration> {
  ...
  @Override
  protected void resetEditorFrom(@NotNull C3BuildRunConfiguration configuration) {
  ...
  @Override
  protected void applyEditorTo(@NotNull C3BuildRunConfiguration configuration)
