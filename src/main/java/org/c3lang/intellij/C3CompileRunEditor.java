...
public class C3CompileRunEditor extends SettingsEditor<C3CompileRunConfiguration> {
  ...
  @Override
  protected void resetEditorFrom(@NotNull C3CompileRunConfiguration configuration) {
  ...
  @Override
  protected void applyEditorTo(@NotNull C3CompileRunConfiguration configuration)
