...
public class C3NewProjectWizard implements LanguageGeneratorNewProjectWizard {
  ...
  @Override
  public @NotNull NewProjectWizardStep createStep(
      @NotNull NewProjectWizardStep newProjectWizardStep) {
  ...
  static class Step extends AbstractNewProjectWizardStep {
    ...
    public Step(NewProjectWizardStep parent) {
      ...
      stdlibPath.addBrowseFolderListener(
    ...
    public void setupProject(@NotNull Project project) {
      ...
      String[] dirs = new String[] {"build", "docs", "lib", "resources", "scripts", "src", "test"};
      ...
      try {
        String name = project.getName().replaceAll("-", "_").replaceAll(" ", "_").toLowerCase();
