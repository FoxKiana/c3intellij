...
public interface C3TokenSets {
  ...
  TokenSet COMMENTS =
      TokenSet.create(
          C3ParserDefinition.LINE_COMMENT,
          C3ParserDefinition.BLOCK_COMMENT,
          C3ParserDefinition.DOC_COMMENT);
  ...
  TokenSet RELATIONAL_OPS =
      TokenSet.create(C3Types.LT_OP, C3Types.LE_OP, C3Types.GT_OP, C3Types.GE_OP);
  ...
  TokenSet OPERATORS = TokenSet.orSet(BINARY_OPS, OTHER_OPERATORS, OPERATOR_ASSIGN_OPS);
  ...
  TokenSet CT_KEYWORDS =
      TokenSet.create(
          C3Types.KW_CT_ALIGNOF,
