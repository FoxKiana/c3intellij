...
public class C3SdkType extends SdkType {
  private static final Logger log = Logger.getInstance(C3SdkType.class);
  ...
  public static boolean isSdkHome(@NotNull String s) {
    ...
    return Files.exists(Paths.get(s, "lib", "std"))
        || Files.exists(Paths.get(s, "..", "lib", "std"));
  }
  ...
  @Override
  public @Nullable AdditionalDataConfigurable createAdditionalDataConfigurable(
