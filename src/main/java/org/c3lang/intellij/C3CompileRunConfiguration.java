...
public class C3CompileRunConfiguration
  ...
  @Override
  protected @NotNull C3CompileRunConfigurationOptions getOptions() {
    ...
    return new CommandLineState(executionEnvironment) {
      ...
      protected @NotNull ProcessHandler startProcess() throws ExecutionException {
        ...
        GeneralCommandLine commandLine =
            new GeneralCommandLine(sdk, "compile-run", getSourceFile());
